...
medalists <- medalists %>% filter(Team %in% top_teams)

# for reordering the plot
medalists$Team <- factor(medalists$Team, levels=top_teams)
medalists$Medal <- factor(medalists$Medal, levels=c("Gold", "Silver", "Bronze"))
