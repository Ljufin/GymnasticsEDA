...
Wait, is GB cheating? Are there actually any repeats?
```{r GB team members}
gym_distinct %>% 
  filter(Year == 1908, Event == "Gymnastics Men's Team All-Around", Team == "Great Britain") %>% 
  .$Name %>% 
  unique()
```
Nope, no repeats. I wish we had more records of what happened and what the rules were at the time. Some of these extra people may have been alternates.
