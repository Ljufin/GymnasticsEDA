...
Unsuprisingly, athlete height and weight are strongly correlated.
```{R, warning=FALSE}
...
Weight and height also have a postive correlation with age, but not as strong as height with weight.
